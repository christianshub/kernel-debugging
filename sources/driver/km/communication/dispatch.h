...
#define READ_REQUEST CTL_CODE(FILE_DEVICE_UNKNOWN, 0x999, METHOD_BUFFERED, FILE_SPECIAL_ACCESS)
...
#define WRITE_REQUEST CTL_CODE(FILE_DEVICE_UNKNOWN, 0xAAA, METHOD_BUFFERED, FILE_SPECIAL_ACCESS)
